...
const Sidebar: React.FC<SidebarProps> = ({ activeView, onViewChange, isLoggedIn, onLoginToggle }) => {
  const navItems = [
  ...
  return (
    <aside className="w-64 bg-tor-dark text-white flex flex-col shrink-0 sticky top-0 h-screen z-20 shadow-2xl">
